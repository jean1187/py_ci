                      ...
                      <div id="bd-login-form" class="" style="margin-top: -175px; zoom: 1; ">
                              <form id="login-form" class="login-form" method="post" action="<?php echo site_url('login'); ?>" autocomplete="off">
                                    <ul>
                                      ...
                                      <li class="buttons">
                                            <a href="<?php echo base_url()?>help/login/sugerencias_y_recomendaciones.html?width=500" class="jTip" id="one" name="Sugerencias y Recomendaciones:"><img src="<?php echo base_url()?>/imagenes/icons/help.png" /></a>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
