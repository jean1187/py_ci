...
<table width="100%" border="1">
  <tr>
    <td height="550" colspan="2" valign="top"><iframe  allowtransparency="yes" frameborder="0" height="550" width="100%"  align="top" src="listaorgano.php"></iframe></td>
  </tr>
  <tr>
    <td width="67%" valign="top"><div id="map" style="width: 100%; height: 520px"></div></td>
    <td width="33%" valign="top"><table width="100%" border="1">
      <tr>
        <td><iframe name="resumen" allowtransparency="yes" frameborder="0" height="520" width="100%"  align="top" src="../bienvenida.php"></iframe></td>
      </tr>
</table></td>
  </tr>
</table>
