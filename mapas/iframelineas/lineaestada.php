...
conectar();	
			...
			$result = mysql_query("SELECT id,organ,norte,este FROM resumen where lineaesta='$id'");
?>
...
<tr>
  ...
  <tr>
    <td><iframe  allowtransparency="yes" frameborder="0" height="520" width="100%" scrolling="auto" align="top" src="listaestrate.php"></iframe></td>
    </tr>
</table>
</td>
  </tr>
