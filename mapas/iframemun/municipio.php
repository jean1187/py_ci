...
conectar();	
			...
			$result = mysql_query("SELECT id,organ,norte,este FROM resumen where munici='$id'");
...
<div align="center" class="fondogris"><strong>Direcci&oacute;n de Proyectos &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>Plan de Inversi&oacute;n por Municipio 2012-2013</strong></div>
...
FROM resumen where munici='$id' ");
 while ($row = mysql_fetch_row($result)){ echo $row['0'];} ?>
  ...
  <tr>
    <td><iframe  allowtransparency="yes" frameborder="0" height="500" width="100%" align="top" src="listamunici.php"></iframe></td>
    </tr>
</table>
</td>
  </tr>
