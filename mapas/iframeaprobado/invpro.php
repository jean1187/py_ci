...
FROM resumen where ti_are=1 ");
			...
			$result = mysql_query("SELECT id,organ,norte,este FROM resumen where ti_are=1 and aprobado=1");
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="30%" valign="top"><table width="100%" border="1">
      <tr>
    <td colspan="2" style="background-color:#F2F2F2"><div align="center" class="tabla">Inversi&oacute;n Productiva</div></td>
    </tr>
      <tr>
