...
FROM resumen where ti_are=3 ");
			...
			$result = mysql_query("SELECT id,organ,norte,este FROM resumen where ti_are=3 and aprobado=1");
...
function load() {
   if (GBrowserIsCompatible()) {
      ...
      map.setCenter(new GLatLng(10.253895015677251,-67.5923216342926),8);   
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="30%" valign="top"><table width="100%" border="1">
      <tr>
    <td colspan="2" style="background-color:#F2F2F2"><div align="center" class="tabla">Infraestructura</div></td>
    </tr>
      <tr>
